import Animated, { Easing, Keyframe, useSharedValue, withSequence, withTiming } from "react-native-reanimated";
...
export default function RevealContainer({ guess, isCorrectPositions, children }: TRevealContainer) {
  ...
  const [container, setContainer] = useState(<View style={[styles.container, { backgroundColor: "#DDDDDD" }]}></View>);
